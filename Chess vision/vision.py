...
def main():
    ...
    lower_white = np.array([135, 135, 135], dtype="uint8")
    upper_white = np.array([145, 145, 145], dtype="uint8")
    ...
    black_contours = cv2.findContours(mask_gray.copy(),
                                      cv2.RETR_TREE,
                                      cv2.CHAIN_APPROX_NONE)[-2]
    cv2.drawContours(image, black_contours, -1, (0, 255, 0), 1)
